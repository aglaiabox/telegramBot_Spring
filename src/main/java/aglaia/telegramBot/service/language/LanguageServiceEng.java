...
@Component
public class LanguageServiceEng extends AbstractLanguageService{

    public LanguageServiceEng(UserBotService userBotService, RegistrationAndSettingService rass) {
        super(userBotService, rass);
    }

    @Override
    public LanguageType setLanguage(Long chatId) {
        return userBotService.setLanguage(chatId, LanguageType.ENG);
    }
}
