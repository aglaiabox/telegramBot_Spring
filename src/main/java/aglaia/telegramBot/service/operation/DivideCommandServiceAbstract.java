...
@Component
public class DivideCommandServiceAbstract extends AbstractGeneratedTaskCommandService {

    public DivideCommandServiceAbstract(UserBotService userBotService, GeneratedTaskService generatedTaskService) {
