...
@Component
public class CommandServiceMultiply extends AbstractGeneratedTaskCommandService {

    public CommandServiceMultiply(UserBotService userBotService, GeneratedTaskService generatedTaskService) {
